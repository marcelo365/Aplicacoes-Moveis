package pt.inesc.termite.termite_wifip2p_chatdesafio;
...
public class MainActivity extends AppCompatActivity implements SimWifiP2pManager.PeerListListener, SimWifiP2pManager.GroupInfoListener{
    ...
    public class OutgoingCommTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            if (result != null) {
                ...
                mTextInput.setHint("Digite uma mensagem");
                mTextInput.setText("");
                mTextOutput.setText("");
                //mTextOutput.setText("");
            }
        ...
        protected Void doInBackground(String... msg) {
            try {
                if (mCliSocket != null && !mCliSocket.isClosed()) {
                    ...
                    mTextOutput.append("Enviado: " + msg[0] + "\n\n");
    ...
    private void guiUpdateInitState() {
        ...
        mTextInput = (EditText) findViewById(R.id.inputDevice);
